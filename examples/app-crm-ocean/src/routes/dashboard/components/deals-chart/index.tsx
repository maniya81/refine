...
import { useLeadPotential } from "@/services/lead.service";

import { mapDealsData } from "./utils";

export const DashboardDealsChart = () => {
  // Fetch lead potential data from API
  const { data: potentialData } = useLeadPotential();

  const dealData = React.useMemo(() => {
    return mapDealsData(potentialData);
  }, [potentialData]);
